...
CREATE TABLE IF NOT EXISTS `ROOM` (
  ...
  CONSTRAINT `ROOM_WING_FLOOR_FK`
    FOREIGN KEY (`Floor` , `WingID` , `BuildingID`)
    REFERENCES `WING_FLOOR` (`FloorNumber` , `WingID` , `BuildingID`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `RES_FEATURES` (
  ...
  `Bed_FeatureID` INT NOT NULL COMMENT 'This field defines the customers requirements for features or beds, which will use a filtered view of the TYPE_NAME lookup table',
...
CREATE INDEX `fk_RES_BEDS_TYPE_NAME1_idx` ON `RES_FEATURES` (`Bed_FeatureID` ASC);
...
CREATE TABLE IF NOT EXISTS `CARD_ASSIGNMENT` (
  ...
  PRIMARY KEY (`CustomerID`, `CardNumber`, `EmployeeID`),
...
CREATE TRIGGER `BUILDING_WING_BEFORE_INSERT` BEFORE INSERT ON `BUILDING_WING` 
  ...
  BEGIN
    ...
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.BuildingID;
    ...
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.WingID;
...
CREATE TRIGGER `hollyhotel`.`RESERVATION_BEFORE_INSERT` BEFORE INSERT ON `RESERVATION` FOR EACH ROW
  BEGIN
    ...
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.RoomType;
...
CREATE TRIGGER `ROOM_BEDS_BEFORE_INSERT` BEFORE INSERT ON `ROOM_BEDS` 
  ...
  BEGIN
    ...
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.BedType;
...
CREATE TRIGGER `hollyhotel`.`RES_FEATURES_BEFORE_INSERT` BEFORE INSERT ON `RES_FEATURES` FOR EACH ROW
  BEGIN
    ...
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.BedFeatureID;
   ...
   ELSEIF NEW.ProximityID not in (select TypeNameID from TYPE_NAME where UsageID = 'ProximityID') then
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.ProximityID;
		SET msg = concat(msg, ' is not a valid Proximity Type');
		SIGNAL sqlstate '45000' SET message_text = msg;
    END;
    END IF;
...
CREATE TRIGGER `hollyhotel`.`STAY_CHARGES_BEFORE_INSERT` BEFORE INSERT ON `STAY_CHARGES` FOR EACH ROW
  BEGIN
    ...
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.ChargeType;
...
CREATE TRIGGER `hollyhotel`.`MAINTENANCE_TICKET_BEFORE_INSERT` BEFORE INSERT ON `MAINTENANCE_TICKET` FOR EACH ROW
  BEGIN
    ...
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.MaintenanceType;
		SET msg = concat(msg, ' is not a valid Maintenance Type');
		SIGNAL sqlstate '45000' SET message_text = msg;
	END; 
    ELSEIF ISNULL(NEW.EndDate,NEW.AnticipatedEndDate)<NEW.StartDate or NEW.AnticpatedEndDate<NEW.StartDate then
    BEGIN
...
CREATE TRIGGER `BUILDWING_FEATURES_BEFORE_INSERT` BEFORE INSERT ON `BUILDING_WING_FEATURES` 
  ...
  BEGIN
    ...
    BEGIN
		SELECT msg = isnull(`Name`,'') from Type_Name where TypeNameID=NEW.FeatureID;
...
START TRANSACTION;
USE `hollyhotel`;
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BuildingID', 'Main Building', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BuildingID', 'Heritage Building', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BuildingID', 'Savanah Building', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'WingID', 'North Wing', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'WingID', 'East Wing', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'WingID', 'South Wing', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'WingID', 'East Wing', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BedType', 'Single Bed', 1);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BedType', 'Double Bed', 2);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BedType', 'Queen Bed', 3);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BedType', 'King Bed', 4);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BedType', 'Fold Out Couch', 0);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BedType', 'Roll-Away Bed', 0);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'BedType', 'Hide-Away Bed (Wall)', 0);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'RoomType', 'Sleeping', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'RoomType', 'Meeting', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'RoomType', 'Suite', NULL);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'MealID', 'Breakfast', 1);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'MealID', 'Lunch', 2);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'MealID', 'Dinner', 3);
INSERT INTO `TYPE_NAME` (`TypeNameID`, `UsageID`, `Name`, `UsageRank`) VALUES (, 'MealID', 'Bar', 4);
